...
let normal = 'How can mirrors be real if our eyes aren\'t real';

String.prototype.toJadenCase = function () {

    let emptyString = ''

    for(let words of this.split(' ')){
        emptyString += words[0].toUpperCase() + words.slice(1) + " "
    }
...
// Afterthought
// Use .join(' ') to create sentence from array
